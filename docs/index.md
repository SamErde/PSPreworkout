...
![Zensical docs deployment workflow status badge](https://img.shields.io/github/actions/workflow/status/SamErde/PSPreworkout/.github%2Fworkflows%2FDeploy%20Zensical.yml?label=Zensical)
