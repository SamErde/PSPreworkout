<#
.SYNOPSIS
    Create a release of the module project.
.DESCRIPTION
...
.EXAMPLE
    ...
    This will perform the default build New-ReleaseTasks: see below for the default Add-BuildTask execution
.EXAMPLE
    Invoke-Build -Add-BuildTask Release

    This will perform only the Release Add-BuildTasks.
.NOTES
