@{
    ...
    PrivateData          = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'This maintenance release fixes a bug in the `New-ScriptFromTemplate` function and adds script validation with PSScriptAnalyzer.`n`nFor more info, see <https://github.com/SamErde/PSPreworkout/releases>.'
