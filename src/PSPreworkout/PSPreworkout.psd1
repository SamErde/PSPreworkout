@{
    ...
    PrivateData          = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = "This maintenance release fixes a bug in how `Get-ModulesWithUpdate` handles prerelease versions.`n`nFor more info, see <https://github.com/SamErde/PSPreworkout/releases>."
