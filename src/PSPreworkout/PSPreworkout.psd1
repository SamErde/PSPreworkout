...
FunctionsToExport = 'Edit-PSReadLineHistoryFile', 'Edit-WinGetSettingsFile', 
               'Get-EnvironmentVariable', 'Get-LoadedAssembly', 
               'Get-PowerShellPortable', 'Get-TypeAccelerator', 
               'Initialize-PSEnvironmentConfiguration', 'Install-OhMyPosh', 
               'Install-PowerShellISE', 'Install-WinGet', 'New-Credential', 
               'New-ScriptFromTemplate', 'Out-JsonFile', 'Set-ConsoleFont', 
               'Set-EnvironmentVariable', 'Show-LoadedAssembly', 
