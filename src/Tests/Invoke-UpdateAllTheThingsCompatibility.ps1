...
$Configuration.Run.Path = @(
    ...
    (Join-Path -Path $PSScriptRoot -ChildPath 'Unit\Update-AllTheThings.Orchestration.Tests.ps1')
    (Join-Path -Path $PSScriptRoot -ChildPath 'Unit\Update-AllTheThings.PackageManagers.Tests.ps1')
    (Join-Path -Path $PSScriptRoot -ChildPath 'Unit\Update-AllTheThings.PowerShell.Tests.ps1')
