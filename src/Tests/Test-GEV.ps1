...
function Test-GEV {
    ...
    Clear-Host
    # Expected: Return all environment variables from all targets.
    ...
    Clear-Host
    # Expected: Return all name matches in the specified targets.
    # Results:  Works as expected.
    ...
    Clear-Host
    # Expected: Return all pattern matches in the specified targets.
    # Results:  Works as expected.
    ...
    Clear-Host
    # Expected: Return all environment variables from the specified target[s].
    # Results:  Works as expected.
    ...
    Clear-Host
    # Expected: Return all name matches in the specified target[s]. Ignore the -All switch.
    # Results:  Works as expected.
    ...
    Clear-Host
    # Expected: Return all pattern matches in the specified target[s]. Ignore the -All switch.
    # Results:  Works as expected.
